    ...
    from-black to-gray-800 p-4 text-white'>
        ...
        max-w-screen-lg mx-auto h-full'>
            ...
            <div className='pb-8'>
                ...
                <p className='py-6'>Feel free to Contact me by submitting the form below and I will get back to you as soon as possible</p>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/a9403017-6182-4a22-9fee-5d859546c51c" 
                method='POST'
                ...
                md:w-1/2'>
                    ...
                    className='p-2 bg-transparent border-2 rounnded-md
                    text-white focus:outline-none' />
                    <input type="text" 
                    name="email" 
                    placeholder='Enter your Email'
                    className='my-4 p-2 bg-transparent border-2 rounnded-md
                    text-white focus:outline-none' />
